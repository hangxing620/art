...
* 置换
  ...
  * 是指将一个物象的局部与另一个物象的局部进行“偷梁换柱”式的移植。

* 形的破坏

  * 残象

    * 对一个完整的形象有意识地破坏，并通过有秩序的破坏过程，使形象破坏的结果产生了新的意义。

  * 裂象

    * 将一个完整的形象作有目的的断裂分离，或分割移位，或破碎处理，并利 用知觉的理解性与恒常性来构筑完整形的意象，能使之产生新的意义和强烈的视觉冲击力。

* 夸张与变形

  * 夸张

    * 是以现实生活为依据，用丰富的想象力和各种对比因素及变形等方法，对面形象的某些典型特征加以夸大和强调的一种表现手段

* 幽默与讽刺

* 倒置

  * 将图形中的形象“倒置”，可刺激人的视觉神经并使之产生兴奋感。

* 摄影蒙太奇

  * 蒙太奇是电影艺术常用的一种表现手法，意为剪辑与组合

* 隐形构成

  * 借助实形存在或共用线、共用形的作用。对画面形象的某些部分有意识地进行隐形处理使主体形象更为简洁、突出并更有利于信息的有效传达。

* 名利作用

  * 对知名度极高的绘画、雕塑、摄影等艺术作品。有意识地进行局部夸张、变形、置换、添加、减少、渐变、突变、移动、分割、错位、重复等

#### 招贴的表现形式与技法

* 绘画表现形式

  * 绘画有多种多样的表现技法，其中主要的有手绘、喷绘与综合三种

* 摄影表现形式

  * 摄影表现形式的出现拓展了现代 招贴设计的表现空间

* 电脑设计

  * 电脑既可真实地表现客观事物。可表现人们幻想中的世界和理想化的形象
